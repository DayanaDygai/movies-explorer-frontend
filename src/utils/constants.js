export const { MOVIES_API_BASE_URL = 'https://api.nomoreparties.co' } = process.env;
export const { MAIN_MOVIES_API_BASE_URL = 'https://api.movies.daiana.nomoredomainswork.ru' } = process.env;
...
export const filterShortFilms = (movies, maxDuration = 40) => movies.filter(film => film.duration <= maxDuration);
