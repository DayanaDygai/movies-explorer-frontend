      ...
      >
        ...
        <button
          className={
            !isFormValid || isLoading
              ? styles['auth-form__submit-button_invalid']
              : styles['authForm__submit-button']
          }
        ...
        {isRegistration ? (
          <p className={styles['auth-form__footer']}>
            ...
            <Link className={styles['auth-form__link']} to="/signin">
              Войти
            </Link>
          </p>
        ) : (
          <p className={styles['auth-form__footer']}>
            ...
            <Link className={styles['auth-form__link']} to="/signup">
              Регистрация
            </Link>
          </p>
        )}
